...
(function() {
  var Barcode, Capture, HTTPParser, Packet, Palette, StackedArea, Stream, Transaction, packet_begin, truncate,
  ...
  window.StackedArea = StackedArea = (function() {
    ...
    StackedArea.prototype.draw = function(capture, palette, bandwidth, intervals) {
      ...
      data = d3.layout.stack()(transactions.map(function(transaction) {
        var i, interval_begin, interval_data, interval_end, packet, packet_duration, packet_end, packet_interval_duration, _i, _j, _len, _ref, _results;
